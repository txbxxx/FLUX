...
```bash
git add cmd/fl/main.go internal/cli/root.go internal/cli/output.go internal/cli/scan_cmd.go internal/cli/root_test.go
...
```bash
go run ./cmd/fl scan
go run ./cmd/fl snapshot create --tools codex,claude --message "first snapshot"
go run ./cmd/fl snapshot list
go run ./cmd/fl tui
```
...
- `go test ./...` passes
- `go run ./cmd/fl --help` shows `scan`, `snapshot`, and `tui`
- `go run ./cmd/fl scan` prints detected tool summaries or a readable empty-state message
- `go run ./cmd/fl snapshot create --tools codex --message "test"` creates a snapshot without panic
- `go run ./cmd/fl snapshot list` shows created snapshots or a readable empty-state message
- `go run ./cmd/fl tui` completes the local workflow end-to-end
